...
public interface StudentClassifiedMapper {
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExampleSelective(@Param("record") StudentClassified record, @Param("example") StudentClassifiedExample example);
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExample(@Param("record") StudentClassified record, @Param("example") StudentClassifiedExample example);
