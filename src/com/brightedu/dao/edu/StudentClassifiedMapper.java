...
public interface StudentClassifiedMapper {
	...
	@Insert({
			...
			"register_date, default_lol)",
			"values (#{classified_id,jdbcType=NUMERIC}, #{classified_name,jdbcType=VARCHAR}, ",
			"#{register_date,jdbcType=TIMESTAMP}, #{default_lol,jdbcType=NUMERIC})" })
	 ...
	 */
	@Select({ "select",
			"classified_id, classified_name, register_date, default_lol",
	...
	@Update({ "update edu.student_classified",
			...
			"default_lol = #{default_lol,jdbcType=NUMERIC}",
			"where classified_id = #{classified_id,jdbcType=NUMERIC}" })
