...
public interface AgentReturnTypeMapper {
     ...
     */
    @Delete({
        "delete from edu.agent_return_type",
     ...
     * @mbggenerated Thu Feb 09 18:11:26 CST 2012
     */
    int updateByExampleSelective(@Param("record") AgentReturnType record, @Param("example") AgentReturnTypeExample example);
     ...
     * @mbggenerated Thu Feb 09 18:11:26 CST 2012
     */
    int updateByExample(@Param("record") AgentReturnType record, @Param("example") AgentReturnTypeExample example);
