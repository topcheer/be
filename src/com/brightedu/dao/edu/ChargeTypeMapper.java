...
public interface ChargeTypeMapper {
	 ...
	 * @mbggenerated  Sat Feb 11 02:04:14 CST 2012
	 */
	@Delete({ "delete from edu.charge_type",
	 ...
	 * @mbggenerated  Sat Feb 11 02:04:14 CST 2012
	 */
	@Select({ "select", "charge_type_id, charge_type_name",
	 ...
	 * @mbggenerated  Sat Feb 11 02:04:14 CST 2012
	 */
	int updateByExampleSelective(@Param("record") ChargeType record,
			@Param("example") ChargeTypeExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table edu.charge_type
	 * @mbggenerated  Sat Feb 11 02:04:14 CST 2012
	 */
	int updateByExample(@Param("record") ChargeType record,
			@Param("example") ChargeTypeExample example);
