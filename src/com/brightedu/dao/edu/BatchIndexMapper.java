...
public interface BatchIndexMapper {
    ...
    @Select({
        "select",
        "batch_id, batch_name, register_date",
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExampleSelective(@Param("record") BatchIndex record, @Param("example") BatchIndexExample example);
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExample(@Param("record") BatchIndex record, @Param("example") BatchIndexExample example);
