...
public interface StudentInfoMapper {
	...
	@Insert({
			...
			"#{update_date,jdbcType=TIMESTAMP}, #{student_photo,jdbcType=BINARY}, ",
	...
	@Select({
			...
			"update_date, student_photo, identity_copy, diploma_copy, network_copy",
	 ...
	 * @mbggenerated  Tue Jan 31 12:29:48 CST 2012
	 */
	@Update({ "update edu.student_info",
