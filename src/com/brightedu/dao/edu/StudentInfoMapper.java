...
public interface StudentInfoMapper {
	...
	@Insert({
			...
			"#{student_status,jdbcType=BIT}, #{register_date,jdbcType=TIMESTAMP}, ",
	...
	@Select({
			...
			"classified_owner, subject_owner, agent_owner, student_status, register_date, ",
			"update_date, birthday, ethnic_group_id, political_status_id, employer, graduate_college_id, ",
			"graduate_date, graduate_certificate_number, postal_code, student_photo, identity_copy, ",
			"diploma_copy, network_copy", "from edu.student_info",
			"where student_id = #{student_id,jdbcType=NUMERIC}" })
	...
	@Update({
			...
			"student_status = #{student_status,jdbcType=BIT},",
