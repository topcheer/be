...
public interface BankOrderMapper {
     ...
     * @mbggenerated Thu Feb 09 18:11:26 CST 2012
     */
    int updateByExampleSelective(@Param("record") BankOrder record, @Param("example") BankOrderExample example);
     ...
     * @mbggenerated Thu Feb 09 18:11:26 CST 2012
     */
    int updateByExample(@Param("record") BankOrder record, @Param("example") BankOrderExample example);
