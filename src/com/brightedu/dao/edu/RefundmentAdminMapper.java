...
public interface RefundmentAdminMapper {
     ...
     */
    @Delete({
        "delete from edu.refundment_admin",
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExampleSelective(@Param("record") RefundmentAdmin record, @Param("example") RefundmentAdminExample example);
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExample(@Param("record") RefundmentAdmin record, @Param("example") RefundmentAdminExample example);
