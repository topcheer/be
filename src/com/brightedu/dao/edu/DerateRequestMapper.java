...
public interface DerateRequestMapper {
     ...
     * This method corresponds to the database table edu.derate_request
     *
     ...
     */
    @Delete({
        "delete from edu.derate_request",
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExampleSelective(@Param("record") DerateRequest record, @Param("example") DerateRequestExample example);
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExampleWithBLOBs(@Param("record") DerateRequest record, @Param("example") DerateRequestExample example);
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExample(@Param("record") DerateRequest record, @Param("example") DerateRequestExample example);
