...
public interface RecruitAgentMapper {
    ...
    @Insert({
        ...
        "#{responsible_person,jdbcType=VARCHAR}, #{contact_person,jdbcType=VARCHAR}, ",
        "#{contact_address,jdbcType=VARCHAR}, #{contact_phone,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "agent_id, agent_name, responsible_person, contact_person, contact_address, contact_phone, ",
        "user_id, college_url, register_date",
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExampleSelective(@Param("record") RecruitAgent record, @Param("example") RecruitAgentExample example);
     ...
     * @mbggenerated Sun Jan 15 18:52:28 CST 2012
     */
    int updateByExample(@Param("record") RecruitAgent record, @Param("example") RecruitAgentExample example);
