...
public interface RecruitAgentMapper {
	...
	@Insert({
			...
			"register_date, parent_agent_id, ",
			"short_name, contact_email, ",
			"contact_qq)",
			...
			"#{register_date,jdbcType=TIMESTAMP}, #{parent_agent_id,jdbcType=NUMERIC}, ",
			"#{short_name,jdbcType=VARCHAR}, #{contact_email,jdbcType=VARCHAR}, ",
			"#{contact_qq,jdbcType=VARCHAR})" })
	...
	@Select({
			...
			"parent_agent_id, short_name, contact_email, contact_qq",
	...
	@Update({ "update edu.recruit_agent",
			...
			"parent_agent_id = #{parent_agent_id,jdbcType=NUMERIC},",
			"short_name = #{short_name,jdbcType=VARCHAR},",
			"contact_email = #{contact_email,jdbcType=VARCHAR},",
			"contact_qq = #{contact_qq,jdbcType=VARCHAR}",
			"where agent_id = #{agent_id,jdbcType=NUMERIC}" })
