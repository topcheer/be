...
public class FunctionsXmlDS extends DataSource {

    private static FunctionsXmlDS instance = null;

    public static FunctionsXmlDS getInstance() {
        if (instance == null) {
            instance = new FunctionsXmlDS("employeesDS");
        }
        return instance;
    }

    public FunctionsXmlDS(String id) {
