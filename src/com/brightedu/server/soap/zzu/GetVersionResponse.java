...
public class GetVersionResponse  implements java.io.Serializable {
    private double getVersionResult;

    public GetVersionResponse() {
    }

    public GetVersionResponse(
           double getVersionResult) {
     ...
     */
    public double getGetVersionResult() {
        return getVersionResult;
    }
     ...
     */
    public void setGetVersionResult(double getVersionResult) {
        this.getVersionResult = getVersionResult;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            this.getVersionResult == other.getGetVersionResult();
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        _hashCode += new Double(getGetVersionResult()).hashCode();
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetVersionResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("getVersionResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "GetVersionResult"));
