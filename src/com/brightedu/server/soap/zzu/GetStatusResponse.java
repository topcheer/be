...
public class GetStatusResponse  implements java.io.Serializable {
     ...
     */
    public boolean isGetStatusResult() {
        return getStatusResult;
    }
     ...
     */
    public void setGetStatusResult(boolean getStatusResult) {
        this.getStatusResult = getStatusResult;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            this.getStatusResult == other.isGetStatusResult();
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        __hashCodeCalc = true;
        int _hashCode = 1;
        _hashCode += (isGetStatusResult() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetStatusResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("getStatusResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "GetStatusResult"));
