...
public class GetStatus  implements java.io.Serializable {
    ...
    /**
     * Gets the gid value for this GetStatus.
     * 
     * @return gid
     */
    ...
    /**
     * Sets the gid value for this GetStatus.
     * 
     * @param gid
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetStatus"));
