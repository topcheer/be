...
<HTML>
<HEAD><TITLE>农行网上支付平台-商户接口范例-指定时间段交易对账单下载</TITLE></HEAD>
<BODY BGCOLOR='#FFFFFF' TEXT='#000000' LINK='#0000FF' VLINK='#0000FF' ALINK='#FF0000'>
<CENTER>指定时间段交易对账单下载<br>
<%
//1、取得商户对账单下载所需要的信息
...
tRequest.setSettleType(SettleFile.SETTLE_TYPE_TRX_BYHOUR);//对账类型 （必要信息）
                     //SettleFile.SETTLE_TYPE_TRX_BYHOUR：指定时间段交易对账单
