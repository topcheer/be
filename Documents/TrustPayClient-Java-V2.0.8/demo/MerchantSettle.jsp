<%
/*
 * @(#)MerchantSettle.jsp	V1.5.1	2004/11/10
 *
 * Project: BJP03004
 *
 * Description:
...
<HTML>
<HEAD><TITLE>农行网上支付平台-商户接口范例-结算对账单下载</TITLE></HEAD>
...
tRequest.setSettleType(SettleFile.SETTLE_TYPE_SETTLE);//对账类型 （必要信息）
                     //SettleFile.SETTLE_TYPE_SETTLE：结算对账单
...
if (tResponse.isSuccess()) {
  ...
  out.println("SettleAmount      = [" + tSettleFile.getSettleAmount     () + "]<br>");
  out.println("Fee               = [" + tSettleFile.getFee              () + "]<br>");
